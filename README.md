...
```shell
& ([scriptblock]::Create((irm "https://debloat.raphi.re/"))) -CLI -RunDefaults -RemoveCommApps -RemoveW11Outlook -RemoveGamingApps -DisableGameBarIntegration -DisableFastStartup -DisableDVR -DisableLockscreenTips -DisableStartRecommended -DisableStartPhoneLink -DisableStoreSearchSuggestions -DisableSearchHighlights -DisableStorageSense -HideHome -HideGallery -DisableBraveBloat -RevertContextMenu -ShowHiddenFolders -HideTaskview -ClearStartAllUsers
```
- Then, run:
```shell
...
- Recommended driver version: [581.94](https://nvidia.custhelp.com/app/answers/detail/a_id/5750/~/geforce-hotfix-display-driver-version-581.94).
